...
public class TaskListDataBase
{
    ...
    public long insertTask(String taskName, String taskDesc, String stat)
    {
        ContentValues initialValues = new ContentValues();
        initialValues.put(TASK_NAME, taskName);
        initialValues.put(TASK_DESCRIPTION, taskDesc);
        initialValues.put(STATUS, stat);
    ...
    //
    public boolean updateTask(long rowId, String firstName, String surname, String city)
    {
        ContentValues args = new ContentValues();
        args.put(TASK_NAME, firstName);
        args.put(TASK_DESCRIPTION, surname);
        args.put(STATUS, city);
